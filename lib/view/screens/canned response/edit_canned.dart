...
import 'all_canned_res.dart';

class EditCaneed extends StatefulWidget {
  CannedResponse cannedResponse;

EditCaneed({required this.cannedResponse}) ;
@override
  State<EditCaneed> createState() => _EditCaneedState();
}

class _EditCaneedState extends State<EditCaneed> {
  ...
  void initState() {
    ...
    super.initState();
    title_controller.text=widget.cannedResponse.title;
    text_controller.text=widget.cannedResponse.message;
    status=widget.cannedResponse.status?status=true:status=false;
  }
  @override
                  ...
                  Padding(
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        Expanded(
                          child: Text('${gettranslated(context, "Edit Canned Response")}',
                              style: TextStyle(
                                fontFamily: 'Roboto',
                                color:_themeProvider.primaryColorLight,
                                fontSize: width*.05,
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                              ...
                              Padding(
                                ...
                                child: Container(
                                  child: FlutterSwitch(activeText: '',inactiveText: '',
                                    ...
                                    _themeProvider.primaryColorLight.withOpacity(0.5):_themeProvider.primaryColorLight,
                          ...
                          InkWell(
                              onTap: ()async{
                             if(cannedResponseEdit.value=="false"){
                               ...
                               if(title_controller.text!=''&&text_controller.text!=''){
                                 var statuscode=      await Admin.editCannedRes(CannedResponse(id: widget.cannedResponse.id, title: title_controller.text, message: text_controller.text,status: status));
                                 statuscode==200?[
                                   Loader.hide(),
