...
import '../employee/add_new_employee.dart';
...
class _CustomerDetailsState extends State<CustomerDetails> {
  ...
  void initState() {
    ...
    first_name_controller..text = widget.customer.first_name;
    last_name_controller..text = widget.customer.last_name;
    // password_controller..text = widget.customer.password;
    mobile_number_controller..text = widget.customer.mobile_number;
    email_controller..text = widget.customer.email;
    country_controller..text = widget.customer.country;
    time_zone_controller..text = widget.customer.timezone;
    gettimezones();
  }
                    ...
                    Padding(
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          Text('${gettranslated(context, "Customer Details")}',
                              style: TextStyle(
                                fontFamily: 'Roboto',
                                color: _themeProvider.primaryColorLight,
                                fontSize: 20,
                             ...
                             if(customersEdit.value=="false"){
                               ...
                               if (timeZoneList
                                 ...
                                 if (first_name_controller.text == '' ||
                                   ...
                                   //add
                                   var status =
                                   await Admin.editCustomer(customer);
                                   status == 200
                                       ? [
                                     Loader.hide(),
